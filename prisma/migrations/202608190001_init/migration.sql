...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'INITIALIZED', 'PAID', 'FAILED', 'CANCELLED', 'REFUNDED');
...
-- CreateEnum
CREATE TYPE "InventoryMovementType" AS ENUM ('PURCHASE', 'SALE', 'RETURN', 'RESTOCK', 'ADJUSTMENT');
...
CREATE TABLE "StoreSetting" (
    ...
    "storeName" TEXT NOT NULL DEFAULT 'MYOKIN',
    "tagline" TEXT NOT NULL DEFAULT 'Beauty in Balance',
    "logo" TEXT,
    "contactEmail" TEXT,
    "phone" TEXT,
    "whatsapp" TEXT,
    ...
    "currency" TEXT NOT NULL DEFAULT 'KES',
    "freeDeliveryThreshold" DECIMAL(12,2),
    "defaultDeliveryFee" DECIMAL(12,2),
    "supportHours" TEXT,
    "seoDefaults" JSONB,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "DeliveryZone_county_town_idx" ON "DeliveryZone"("county", "town");
